				...
				<Row>
					<Col lg="6" className={`${classes.about__content}`}>
						...
						<p>
							...
							web and software development expertise. I like trying out new web
							technologies and learning about them. Javascript, Typescript,
							HTML5, CSS3, Bootstrap 5, Tailwind, API, React, Node js, Express
							js, Mongodb, Mongoose and C programming are among my strong suits.
							I use data structures and algorithms to try to address a variety
							of issues.
						</p>
